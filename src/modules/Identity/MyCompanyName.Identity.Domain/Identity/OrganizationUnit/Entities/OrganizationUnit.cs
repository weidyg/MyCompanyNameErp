...
{
    public class OrganizationUnit : FullAuditedAggregateRoot<Guid>, IMultiTenant, IMultiCompany
    {
        ...
        {
            if (childCode.IsNullOrEmpty()) { throw new ArgumentNullException(nameof(childCode), "childCode can not be null or empty."); }
