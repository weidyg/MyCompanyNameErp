    ...
    public static class IdentityDbContextModelCreatingExtensions
    {
            ...
            Action<IdentityModelBuilderConfigurationOptions> optionsAction = null)
        {
            ...
            builder.Entity<IdentityUser>(b =>
            {
                ...
                b.Property(u => u.CompanyId).HasColumnName(nameof(IdentityUser.CompanyId));
                ...
                b.Property(u => u.Email).HasMaxLength(IdentityUserConsts.MaxEmailLength).HasColumnName(nameof(IdentityUser.Email));
                b.Property(u => u.Name).HasMaxLength(IdentityUserConsts.MaxNameLength).HasColumnName(nameof(IdentityUser.Name));
                ...
                b.Property(u => u.PhoneNumber).HasMaxLength(IdentityUserConsts.MaxPhoneNumberLength).HasColumnName(nameof(IdentityUser.PhoneNumber));
                ...
                b.Property(u => u.IsExternal).IsRequired().HasDefaultValue(false).HasColumnName(nameof(IdentityUser.IsExternal));
                b.Property(u => u.AccessFailedCount).If(!builder.IsUsingOracle(), p => p.HasDefaultValue(0)).HasColumnName(nameof(IdentityUser.AccessFailedCount));
            ...
            {
                b.ToTable(options.TablePrefix + "Companys", options.Schema);
                b.ConfigureByConvention();
                b.Property(ou => ou.Name).IsRequired().HasMaxLength(IdentityCompanyConsts.MaxNameLength);
                b.HasMany(ou => ou.LinkTenants).WithOne().HasForeignKey(ou => ou.CompanyId);
                b.HasIndex(ou => ou.Name);
            });

            builder.Entity<CompanyLinkTenant>(b =>
            {
                b.ToTable(options.TablePrefix + "CompanyLinkTenants", options.Schema);
                b.ConfigureByConvention();
                b.HasIndex(ou => new { ou.CompanyId, ou.TenantId, ou.ClientType });
            });
