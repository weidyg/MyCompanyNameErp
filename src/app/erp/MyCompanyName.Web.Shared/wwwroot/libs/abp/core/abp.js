...
(function () {
    ...
    abp.notify.success = function (message, title, options) {
        options = options || {}; options.message = title; options.description = message;
        window.parent.antd.notification.success(options);
    };

    abp.notify.info = function (message, title, options) {
        options = options || {}; options.message = title; options.description = message;
        window.parent.antd.notification.info(options);
    };

    abp.notify.warn = function (message, title, options) {
        options = options || {}; options.message = title; options.description = message;
        window.parent.antd.notification.warn(options);
    };

    abp.notify.error = function (message, title, options) {
        options = options || {}; options.message = title; options.description = message;
        window.parent.antd.notification.error(options);
    };
    ...
    abp.message.info = function (message, title) {
        return window.parent.antd.message.info(message || title);
    };

    abp.message.success = function (message, title) {
        return window.parent.antd.message.success(message || title);
    };

    abp.message.warn = function (message, title) {
        return window.parent.antd.message.warning(message || title);
    };

    abp.message.error = function (message, title) {
        return window.parent.antd.message.error(message || title);
    };
