...
{
    public class EfCoreIdentityRoleRepository : EfCoreRepository<ErpDbContext, IdentityRole, Guid>, IIdentityRoleRepository
    {
        public EfCoreIdentityRoleRepository(IDbContextProvider<ErpDbContext> dbContextProvider)
