...
{
    public class EfCorePermissionGrantRepository : EfCoreRepository<ErpDbContext, PermissionGrant, Guid>, IPermissionGrantRepository
    {
        public EfCorePermissionGrantRepository(IDbContextProvider<ErpDbContext> dbContextProvider)
