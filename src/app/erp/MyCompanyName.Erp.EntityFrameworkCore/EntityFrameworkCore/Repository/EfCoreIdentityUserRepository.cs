...
namespace Sunton.Erp.EntityFrameworkCore.Repository
{
    public class EfCoreIdentityUserRepository : EfCoreRepository<ErpDbContext, IdentityUser, Guid>, IIdentityUserRepository
    {
        public EfCoreIdentityUserRepository(IDbContextProvider<ErpDbContext> dbContextProvider)
